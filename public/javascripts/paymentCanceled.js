/** The below sets a loading animation for the page to load and then redirects the page
 * 1. Show the loading animation until the page loads then hide loading animation and show the page content
 * 2. Loading screen animation
 * 3. Redirects the user after 8s back to the checkout page 
 */
...
/* 3
Redirects the user back to the checkout page */
